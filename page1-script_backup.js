document.addEventListener('DOMContentLoaded', function () {
  ...
  function createReagentInput(number) {
    ...
    div.innerHTML = `
            <h4>Reagent ${number} <button type="button" class="remove-reagent" onclick="removeReagent(this)">Remove</button></h4>
            <label>Name:</label>
            <input type="text" class="reagent-name" placeholder="Reagent name" required>
            <label>Mass (g):</label>
            <input type="number" class="reagent-mass" step="0.001" placeholder="Mass" required>
            <label>Molar mass (g/mol):</label>
            <input type="number" class="reagent-molar-mass" step="0.001" placeholder="Molar mass" required>
            <label>Coefficient in equation:</label>
            <input type="number" class="reagent-coefficient" placeholder="Coefficient" required>
        `
